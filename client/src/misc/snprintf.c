 ...
 *		  not used;
 * 2003-06-18 (No version) Euan MacGregor
 *		- Patched to placate warnings when building with HAVE_SNPRINTF.
 */
...
#if defined(HAVE_SNPRINTF)
void dummy() {
    char* x = credits; /* Keep compiler happy about credits being defined but unused.*/
    x = NULL;
}
#endif
   ...
   /* insert padding to the left as requested by min_field_width;
      ...
      if (!justify_left) {                /* left padding with blank or zero */
        ...
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
            fast_memset(str+str_l, (zero_padding?'0':' '), ((unsigned)n>avail?avail:(unsigned)n));
          }
          str_l += n;
        }
      }
    ...
    * for numeric conversions required? */
     ...
     /* insert first part of numerics (sign or '0x') before zero padding */
        ...
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
            fast_memcpy(str+str_l, str_arg, ((unsigned)n>avail?avail:(unsigned)n));
          }
          str_l += n;
        }
     /* insert zero padding as requested by the precision or min field width */
        ...
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
            fast_memset(str+str_l, '0', ((unsigned)n>avail?avail:(unsigned)n));
          }
          str_l += n;
        }
      }
        ...
        if (n > 0) {
          if (str_l < str_m) {
            ...
            fast_memcpy(str+str_l, str_arg+zero_padding_insertion_ind,
                        ((unsigned)n>avail?avail:(unsigned)n));
          }
          str_l += n;
        }
      }
   /* insert right padding */
      if (justify_left) {          /* right blank padding to the field width */
        ...
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
            fast_memset(str+str_l, ' ', ((unsigned)n>avail?avail:(unsigned)n));
          }
          str_l += n;
        }
      }
